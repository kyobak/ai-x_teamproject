...
- **2026-09-19 (Claude, 배포)**: Render 무료 플랜에 백엔드(https://erica-wait-api.onrender.com), Vercel 에 웹앱(https://erica-wait.vercel.app) 배포 완료. 서버 시간대 UTC 문제 → Asia/Seoul 고정. 웹앱은 Git 미연결이라 수정 후 `npx vercel deploy --prod --yes` 필요. 관리자 PIN·기기 키는 Render Environment 탭.
