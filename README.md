...
| Should. 셔틀 | 실제 시간표(2023.09.01, 학기 중·주말) 5개 방향. 다음 차까지 남은 분 + "지금 줄 서면 몇 시 차" (줄 인원 ÷ 정원) | ✅ 동작 |
| Could. 오픈스페이스 | 5개 건물(융합교육관·체육관·경상관·솔성관·과기대). 입구 QR 체크인 또는 카메라 실내 계수 → 재실 인원 | ✅ 동작 |
...
/space            오픈스페이스 5곳 (여유 순)             → /space/[id] 재실·체크인
/shuttle          정류장·방향 5개                        → /shuttle/[id] 남은 시간·탑승 예측·시간표
